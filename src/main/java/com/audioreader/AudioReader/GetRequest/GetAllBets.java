...
public class GetAllBets {
    ...
    public List<Winners> getAllBets() {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("select full_name, bet from users join user_daily_bets on users.user_id = user_daily_bets.user_id where date = ?;");
